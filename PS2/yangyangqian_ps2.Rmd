...
q5$t <- ( q5$mu_control-q5$mu_treatment ) / ( sqrt( (q5$sd_control^2)/q5$n_control + (q5$sd_treatment^2)/q5$n_treatment ) ) #2.821144


# uses the t statistic to calculate 95% confidence interval
(q5$mu_control-q5$mu_treatment) + qt(q5$t)


# sanity check, use the t.test function
t.test(q5$bids_control, q5$bids_treatment)
# t = 2.8211, df = 61.983
# 95 percent confidence interval: 3.557141 20.854624
```
