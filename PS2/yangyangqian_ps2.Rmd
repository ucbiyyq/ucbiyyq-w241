...
**for Texas, the effect of having a two-year term on the number of bills introduced is about -17**

**for Arkansas, the effect of having a two-year term on the number of bills introduced is about -11**
...
note, from GG, the formula for estimating the standard error of the ATE (no blocking) is

$$\hat{SE}=\sqrt{\frac{\hat{Var}(Y_i(0))}{N-m} + \frac{\hat{Var}(Y_i(1))}{m}}$$

and the formula for estimating the standard error of the ATE with 2 blocks is
